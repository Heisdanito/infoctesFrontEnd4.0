<?php
// ============================================================
//  web_server/auth/rep/authLogin.php
//  Web course rep login — index number + 10-digit PIN
//
//  POST /web_server/auth/rep/authLogin.php
...
if (empty($student['pin_hash']) || !password_verify($pin, $student['pin_hash'])) {
    sendResponse(false, 'Incorrect PIN.', [], 401);
}

// ── Confirm course rep assignment ─────────────────────────────
$repStmt = $db->prepare("SELECT id FROM course_rep WHERE student_id = ? LIMIT 1");
